...
# from googleReviews.auth import find_user
...
def create_app():
    ...
    from googleReviews.views import views
    from googleReviews.auth import auth

    app.register_blueprint(views, url_prefix='/')

    app.register_blueprint(auth, url_prefix='/') #'/' means no prefix

    from googleReviews.models import User,Review
    # create_database(app)
